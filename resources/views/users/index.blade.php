        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <div class="d-flex justify-content-end">
                    <a href="{{ route('users.add') }}" class="btn btn-primary mb-2">Add User</a>
                </div>
                                        ...
                                        <td>
                                            ...
                                            @if(session('user_role') == 'Admin' && $item['user_role'] == 'Super Admin')
                                                ...
                                                @else
                                                    ...
                                                    <a href="{{ url('users/edit-user/' . $key) }}" class="btn btn-sm btn-success me-2">Edit</a>
                                                    <button type="button" class="btn btn-sm btn-secondary" data-bs-toggle="modal" data-bs-target="#archiveModal" data-id="{{ $key }}" data-name="{{ $item['first_name'] }} {{ $item['last_name'] }}">Archive</button>
                                                @endif
                                            </div>
                                        </td>
                                    </tr>
    ...
    archiveButtons.forEach(button => {
        button.addEventListener('click', function() {
            ...
            confirmArchiveButton.onclick = function() {
                window.location.href = '{{ url("users/delete-user/") }}/' + userId;
            };
        });
    });
</script>
